...
router.get('/', authMiddleware(), async (req, res) => {
    try {
        ...
        equipmentStatsAgg.forEach(stat => {
            switch (stat._id) {
                case 'Disponible':
                    equipmentStats.disponible = stat.count;
                    break;
                case 'Assigné':
                    equipmentStats.assigne = stat.count;
                    break;
                case 'En panne':
                    equipmentStats.enPanne = stat.count;
                    break;
                case 'En maintenance':
                    equipmentStats.enMaintenance = stat.count;
                    break;
                case 'Réservé':
                    equipmentStats.reserve = stat.count;
                    break;
            }
        ...
        incidentsCountAgg.forEach(stat => {
            if (stat._id === 'En cours')
                activeIncidents = stat.count;
            if (stat._id === 'Résolu')
