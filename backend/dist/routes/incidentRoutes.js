...
const { createIncident, getIncidents, getIncident, updateIncident, deleteIncident, recentIncidents, assignIncident, getIncidentStats } = require('../controllers/incidentController');
